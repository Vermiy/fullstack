  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30 px-4">
      <div className="w-full max-w-sm rounded-xl border border-(--border) bg-(--surface) p-5 shadow-[0_14px_30px_rgba(117,74,28,0.18)]">
        <h2 className="text-foreground text-lg font-semibold">Create book</h2>
        <p className="mt-1 text-sm text-[#6f5438]">Add a new book to the library.</p>

        <form className="mt-4 space-y-3" onSubmit={onSubmit}>
          <div>
            <label htmlFor="create-book-name" className="mb-1 block text-sm text-[#5d462f]">
              Name
            </label>
            <input
              id="create-book-name"
          ...
          <div>
            <label htmlFor="create-book-author" className="mb-1 block text-sm text-[#5d462f]">
              Author
            </label>
            <input
          ...
          <div>
            <label htmlFor="create-book-page-count" className="mb-1 block text-sm text-[#5d462f]">
              Page count
            </label>
            <input
